...
class ControllerNode(Node):
    def __init__(self):
        ...
        self.cmd_vel_pub = self.create_publisher(Twist,'sang/cmd_vel',10)
        self.remaining_pizza_pub_ = self.create_publisher(Int64,'sang/pizza_count',10)
        
        self.create_subscription(Twist, '/cmd_vel', self.callback_abs_cmd, 10)
        self.create_subscription(Pose, 'sang/pose', self.callback_pose, 10)
        self.create_subscription(Int64, 'sang/pizza_count',self.pizza_count_callback,10)
