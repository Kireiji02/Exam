...
#ifndef TURTLESIM_PLUS_INTERFACES__SRV__DETAIL__YAML_REQ__FUNCTIONS_H_
#define TURTLESIM_PLUS_INTERFACES__SRV__DETAIL__YAML_REQ__FUNCTIONS_H_
...
/// Initialize srv/YamlReq message.
/**
...
/// Create srv/YamlReq message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * turtlesim_plus_interfaces__srv__YamlReq_Request__init().
...
/// Destroy srv/YamlReq message.
/**
 * It calls
 * turtlesim_plus_interfaces__srv__YamlReq_Request__fini()
...
/// Check for srv/YamlReq message equality.
/**
...
/// Initialize array of srv/YamlReq messages.
/**
...
/// Finalize array of srv/YamlReq messages.
/**
 * It calls
 * turtlesim_plus_interfaces__srv__YamlReq_Request__fini()
...
/// Create array of srv/YamlReq messages.
/**
 * It allocates the memory for the array and calls
 * turtlesim_plus_interfaces__srv__YamlReq_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/YamlReq messages.
/**
 * It calls
 * turtlesim_plus_interfaces__srv__YamlReq_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/YamlReq message array equality.
/**
...
/// Copy an array of srv/YamlReq messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * turtlesim_plus_interfaces__srv__YamlReq_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_plus_interfaces
...
/**
 * It calls
 * turtlesim_plus_interfaces__srv__YamlReq_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_plus_interfaces
...
/**
 * It allocates the memory for the array and calls
 * turtlesim_plus_interfaces__srv__YamlReq_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtlesim_plus_interfaces
...
/**
 * It calls
 * turtlesim_plus_interfaces__srv__YamlReq_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TURTLESIM_PLUS_INTERFACES__SRV__DETAIL__YAML_REQ__FUNCTIONS_H_
